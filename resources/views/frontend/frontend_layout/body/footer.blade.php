<footer id="footer" class="footer color-bg">
        ...
        <div class="row">
            ...
            <div class="module-body">
                ...
                <li class="media">
                    ...
                    <div class="media-body"> <span><a href="#">admin@unimall.com</a></span> </div>
                </li>
                </ul>
            </div>
            <!-- /.module-body --> 
    ...
    <div class="copyright-bar">
        ...
        <div class="col-xs-12 col-sm-6 no-padding">
            ...
            <ul>
                <li><img src="{{ asset('frontend') }}/assets/images/payments/mtn.png" alt="" style="height:30px;width:40px"></li>
